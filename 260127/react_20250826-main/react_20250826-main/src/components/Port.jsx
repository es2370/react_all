            ...
            <div className="port_inner">
                ...
                <div className="port_wrap">
                    <article className='port_item p1'>
                        ...
                        <div className="desc">
                            1. Lorem ipsum dolor sit amet consectetur adipisicing elit. Iste voluptates consequuntur accusamus exercitationem dolorem deleniti!
                        </div>
                    ...
                    <article className='port_item p2'>
                        ...
                        <div className="desc">
                            2. Lorem ipsum dolor sit amet consectetur adipisicing elit. Iste voluptates consequuntur accusamus exercitationem  Iste voluptates consequuntur accusamus exercitationem  dolorem deleniti!
                        </div>
                        <a href="/" target='_blank' className='site' rel='noreferrer noopener'>사이트 보기</a>
                    </article>
                    <article className='port_item p3'>
                        ...
                        <div className="desc">
                            3. Lorem ipsum dolor sit amet consectetur adipisicing elit. Iste voluptates consequuntur accusamus exercitationem dolorem deleniti! dolor sit amet consectetur adipisicing elit dolor sit amet consectetur adipisicing elit.
                        </div>
                        <a href="/" target='_blank' className='site' rel='noreferrer noopener'>사이트 보기</a>
                    </article>
                    <article className='port_item p4'>
                        ...
                        <div className="desc">
                            4. Lorem ipsum dolor sit amet consectetur adipisicing elit. Iste voluptates consequuntur accusamus exercitationem dolorem deleniti!
                        </div>
                        <a href="/" target='_blank' className='site' rel='noreferrer noopener'>사이트 보기</a>
                    </article>
                    <article className='port_item p5'>
                        ...
                        <div className="desc">
                            5. Lorem ipsum dolor sit amet consectetur adipisicing elit. Iste voluptates consequuntur accusamus exercitationem dolorem deleniti!
                        </div>
                        <a href="/" target='_blank' className='site' rel='noreferrer noopener'>사이트 보기</a>
                    </article>
                    <article className='port_item p6'>
                        ...
                        <div className="desc">
                            6. Lorem ipsum dolor sit amet consectetur adipisicing elit. Iste voluptates consequuntur accusamus exercitationem dolorem deleniti!
                        </div>
                        <a href="/" target='_blank' className='site' rel='noreferrer noopener'>사이트 보기</a>
                    </article>
                </div>
